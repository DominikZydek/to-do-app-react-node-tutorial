...
function Auth() {
  ...
  console.log(email, password, confirmPassword, error, isLogIn);
        ...
        <div className="auth-container-box">
          ...
          <div className="auth-options">
            <button
              ...
              style={{backgroundColor: !isLogIn ? 'rgb(255, 255, 255)' : 'rgb(188, 188, 188)'}}>Sign Up
            </button>
            <button
            onClick={() => viewLogin(true)}
            style={{backgroundColor: isLogIn ? 'rgb(255, 255, 255)' : 'rgb(188, 188, 188)'}}>Login
            </button>
          </div>
        </div>
      </div>
